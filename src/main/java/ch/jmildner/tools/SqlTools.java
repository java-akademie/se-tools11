...
public class SqlTools
{
    ...
    public static void executeUpdate(Statement s, String sql, boolean... pause) throws IOException
    {
        try
        {
    ...
    public static void execute(Statement s, String sql, boolean... pause) throws IOException
    {
        try
        {
    ...
    public static void select(Statement s, String sql, int... kza) throws IOException
    {
    ...
    private static void printSQLException(String sql, SQLException e, boolean... pause) throws IOException
    {
